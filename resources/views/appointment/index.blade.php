...
@section('content')
                                    ...
                                    <div class="d-flex align-items-center overflow-auto pt-3 pt-lg-0">
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <select
                                                ...
                                                data-select2-id="select2-data-7-ynxw" tabindex="-1" aria-hidden="true">
                                                <option value=""></option>
                                                    ...
                                                    <div class="modal-body py-10 px-lg-17">
                                                        ...
                                                        <div class="fv-row mb-9 fv-plugins-icon-container">
                                                            ...
                                                            <input type="text" class="form-control form-control-solid"
                                                                placeholder="" name="calendar_event_name" value="">
                                                            <!--end::Input-->
                        ...
                        <div class="mh-300px scroll-y me-n7 pe-7">
                            ...
                            <div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
                                ...
                                <div class="ms-2 w-100px">
                                    <select class="form-select form-select-solid form-select-sm select2-hidden-accessible"
                                        ...
                                        data-select2-id="select2-data-10-k75c" tabindex="-1" aria-hidden="true">
                                        ...
                                        style="width: 100%;"><span class="selection"><span
                                                ...
                                                aria-controls="select2-1c1d-container"><span
                                                    class="select2-selection__rendered" id="select2-1c1d-container"
                            ...
                            <div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
                                ...
                                <div class="ms-2 w-100px">
                                    <select class="form-select form-select-solid form-select-sm select2-hidden-accessible"
                                        data-control="select2" data-hide-search="true"
                                        data-select2-id="select2-data-13-3ekn" tabindex="-1" aria-hidden="true">
                                        <option value="1" selected="selected"
                                        ...
                                        style="width: 100%;"><span class="selection"><span
                                                ...
                                                aria-controls="select2-jqj9-container"><span
                                                    class="select2-selection__rendered" id="select2-jqj9-container"
                                                    role="textbox" aria-readonly="true"
                            ...
                            <div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
                                ...
                                <div class="ms-2 w-100px">
                                    <select class="form-select form-select-solid form-select-sm select2-hidden-accessible"
                                        data-control="select2" data-hide-search="true"
                                        data-select2-id="select2-data-16-i72s" tabindex="-1" aria-hidden="true">
                                        <option value="1">Guest</option>
                                        <option value="2">Owner</option>
                                        ...
                                        style="width: 100%;"><span class="selection"><span
                                                ...
                                                aria-controls="select2-3kcl-container"><span
                                                    class="select2-selection__rendered" id="select2-3kcl-container"
                            ...
                            <div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
                                ...
                                <div class="ms-2 w-100px">
                                    <select class="form-select form-select-solid form-select-sm select2-hidden-accessible"
                                        data-control="select2" data-hide-search="true"
                                        data-select2-id="select2-data-19-avam" tabindex="-1" aria-hidden="true">
                                        <option value="1">Guest</option>
                                        <option value="2" selected="selected"
                                        ...
                                        style="width: 100%;"><span class="selection"><span
                                                ...
                                                aria-controls="select2-77de-container"><span
                                                    class="select2-selection__rendered" id="select2-77de-container"
                                                    role="textbox" aria-readonly="true"
                                                    title="Owner">Owner</span><span class="select2-selection__arrow"
                                                    role="presentation"><b
                                                        role="presentation"></b></span></span></span><span
                            ...
                            <div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
                                ...
                                <div class="ms-2 w-100px">
                                    <select class="form-select form-select-solid form-select-sm select2-hidden-accessible"
                                        data-control="select2" data-hide-search="true"
                                        data-select2-id="select2-data-22-8mj6" tabindex="-1" aria-hidden="true">
                                        <option value="1">Guest</option>
                                        <option value="2">Owner</option>
                                        <option value="3" selected="selected"
                                        ...
                                        style="width: 100%;"><span class="selection"><span
                                                ...
                                                aria-controls="select2-av2t-container"><span
                                                    class="select2-selection__rendered" id="select2-av2t-container"
                                                    role="textbox" aria-readonly="true" title="Can Edit">Can
                                                    Edit</span><span class="select2-selection__arrow"
                                                    role="presentation"><b
                                                        role="presentation"></b></span></span></span><span
                            ...
                            <div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
                                ...
                                <div class="ms-2 w-100px">
                                    <select class="form-select form-select-solid form-select-sm select2-hidden-accessible"
                                        data-control="select2" data-hide-search="true"
                                        data-select2-id="select2-data-25-183i" tabindex="-1" aria-hidden="true">
                                        <option value="1">Guest</option>
                                        <option value="2" selected="selected"
                                        ...
                                        style="width: 100%;"><span class="selection"><span
                                                ...
                                                aria-controls="select2-9cez-container"><span
                                                    class="select2-selection__rendered" id="select2-9cez-container"
                                                    role="textbox" aria-readonly="true"
                                                    title="Owner">Owner</span><span class="select2-selection__arrow"
                                                    role="presentation"><b
                                                        role="presentation"></b></span></span></span><span
                            ...
                            <div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
                                ...
                                <div class="ms-2 w-100px">
                                    <select class="form-select form-select-solid form-select-sm select2-hidden-accessible"
                                        data-control="select2" data-hide-search="true"
                                        data-select2-id="select2-data-28-0ryd" tabindex="-1" aria-hidden="true">
                                        <option value="1">Guest</option>
                                        <option value="2">Owner</option>
                                        <option value="3" selected="selected"
                                        ...
                                        style="width: 100%;"><span class="selection"><span
                                                ...
                                                aria-controls="select2-4vns-container"><span
                                                    class="select2-selection__rendered" id="select2-4vns-container"
                                                    role="textbox" aria-readonly="true" title="Can Edit">Can
                                                    Edit</span><span class="select2-selection__arrow"
                                                    role="presentation"><b
                                                        role="presentation"></b></span></span></span><span
                            ...
                            <div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
                                ...
                                <div class="ms-2 w-100px">
                                    <select class="form-select form-select-solid form-select-sm select2-hidden-accessible"
                                        data-control="select2" data-hide-search="true"
                                        data-select2-id="select2-data-31-2waq" tabindex="-1" aria-hidden="true">
                                        <option value="1">Guest</option>
                                        <option value="2" selected="selected"
                                        ...
                                        style="width: 100%;"><span class="selection"><span
                                                ...
                                                aria-controls="select2-dwrf-container"><span
                                                    class="select2-selection__rendered" id="select2-dwrf-container"
                                                    role="textbox" aria-readonly="true"
                                                    title="Owner">Owner</span><span class="select2-selection__arrow"
                                                    role="presentation"><b
                                                        role="presentation"></b></span></span></span><span
                            ...
                            <div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
                                ...
                                <div class="ms-2 w-100px">
                                    <select class="form-select form-select-solid form-select-sm select2-hidden-accessible"
                                        data-control="select2" data-hide-search="true"
                                        data-select2-id="select2-data-34-ugvf" tabindex="-1" aria-hidden="true">
                                        <option value="1" selected="selected"
                                        ...
                                        style="width: 100%;"><span class="selection"><span
                                                ...
                                                aria-controls="select2-rnt3-container"><span
                                                    class="select2-selection__rendered" id="select2-rnt3-container"
                                                    role="textbox" aria-readonly="true"
                                                    title="Guest">Guest</span><span class="select2-selection__arrow"
                                                    role="presentation"><b
                                                        role="presentation"></b></span></span></span><span
                            ...
                            <div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
                                ...
                                <div class="ms-2 w-100px">
                                    <select class="form-select form-select-solid form-select-sm select2-hidden-accessible"
                                        data-control="select2" data-hide-search="true"
                                        data-select2-id="select2-data-37-f3zz" tabindex="-1" aria-hidden="true">
                                        <option value="1">Guest</option>
                                        <option value="2">Owner</option>
                                        <option value="3" selected="selected"
                                        ...
                                        style="width: 100%;"><span class="selection"><span
                                                ...
                                                aria-controls="select2-t6b0-container"><span
                                                    class="select2-selection__rendered" id="select2-t6b0-container"
                                                    role="textbox" aria-readonly="true" title="Can Edit">Can
                                                    Edit</span><span class="select2-selection__arrow"
                                                    role="presentation"><b
                                                        role="presentation"></b></span></span></span><span
                            ...
                            <div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
                                ...
                                <div class="ms-2 w-100px">
                                    <select class="form-select form-select-solid form-select-sm select2-hidden-accessible"
                                        data-control="select2" data-hide-search="true"
                                        data-select2-id="select2-data-40-3td3" tabindex="-1" aria-hidden="true">
                                        <option value="1">Guest</option>
                                        <option value="2" selected="selected"
                                        ...
                                        style="width: 100%;"><span class="selection"><span
                                                ...
                                                aria-controls="select2-wid8-container"><span
                                                    class="select2-selection__rendered" id="select2-wid8-container"
                                                    role="textbox" aria-readonly="true"
                                                    title="Owner">Owner</span><span class="select2-selection__arrow"
                                                    role="presentation"><b
                                                        role="presentation"></b></span></span></span><span
                            ...
                            <div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
                                ...
                                <div class="ms-2 w-100px">
                                    <select class="form-select form-select-solid form-select-sm select2-hidden-accessible"
                                        data-control="select2" data-hide-search="true"
                                        data-select2-id="select2-data-43-s88l" tabindex="-1" aria-hidden="true">
                                        <option value="1" selected="selected"
                                        ...
                                        style="width: 100%;"><span class="selection"><span
                                                ...
                                                aria-controls="select2-p2sn-container"><span
                                                    class="select2-selection__rendered" id="select2-p2sn-container"
                                                    role="textbox" aria-readonly="true"
                                                    title="Guest">Guest</span><span class="select2-selection__arrow"
                                                    role="presentation"><b
                                                        role="presentation"></b></span></span></span><span
                            ...
                            <div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
                                ...
                                <div class="ms-2 w-100px">
                                    <select class="form-select form-select-solid form-select-sm select2-hidden-accessible"
                                        data-control="select2" data-hide-search="true"
                                        data-select2-id="select2-data-46-9p6j" tabindex="-1" aria-hidden="true">
                                        <option value="1">Guest</option>
                                        <option value="2">Owner</option>
                                        <option value="3" selected="selected"
                                        ...
                                        style="width: 100%;"><span class="selection"><span
                                                ...
                                                aria-controls="select2-sei9-container"><span
                                                    class="select2-selection__rendered" id="select2-sei9-container"
                                                    role="textbox" aria-readonly="true" title="Can Edit">Can
                                                    Edit</span><span class="select2-selection__arrow"
                                                    role="presentation"><b
                                                        role="presentation"></b></span></span></span><span
                            ...
                            <div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
                                ...
                                <div class="ms-2 w-100px">
                                    <select class="form-select form-select-solid form-select-sm select2-hidden-accessible"
                                        data-control="select2" data-hide-search="true"
                                        data-select2-id="select2-data-49-7bsx" tabindex="-1" aria-hidden="true">
                                        <option value="1">Guest</option>
                                        <option value="2">Owner</option>
                                        <option value="3" selected="selected"
                                        ...
                                        style="width: 100%;"><span class="selection"><span
                                                ...
                                                aria-controls="select2-qufy-container"><span
                                                    class="select2-selection__rendered" id="select2-qufy-container"
                                                    role="textbox" aria-readonly="true" title="Can Edit">Can
                                                    Edit</span><span class="select2-selection__arrow"
                                                    role="presentation"><b
                                                        role="presentation"></b></span></span></span><span
                            ...
                            <div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
                                ...
                                <div class="ms-2 w-100px">
                                    <select class="form-select form-select-solid form-select-sm select2-hidden-accessible"
                                        data-control="select2" data-hide-search="true"
                                        data-select2-id="select2-data-52-gz0z" tabindex="-1" aria-hidden="true">
                                        <option value="1">Guest</option>
                                        <option value="2" selected="selected"
                                        ...
                                        style="width: 100%;"><span class="selection"><span
                                                ...
                                                aria-controls="select2-sob7-container"><span
                                                    class="select2-selection__rendered" id="select2-sob7-container"
                                                    role="textbox" aria-readonly="true"
                                                    title="Owner">Owner</span><span class="select2-selection__arrow"
                                                    role="presentation"><b
                                                        role="presentation"></b></span></span></span><span
                            ...
                            <div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
                                ...
                                <div class="ms-2 w-100px">
                                    <select class="form-select form-select-solid form-select-sm select2-hidden-accessible"
                                        data-control="select2" data-hide-search="true"
                                        data-select2-id="select2-data-55-3gwa" tabindex="-1" aria-hidden="true">
                                        <option value="1" selected="selected"
                                        ...
                                        style="width: 100%;"><span class="selection"><span
                                                ...
                                                aria-controls="select2-qrjm-container"><span
                                                    class="select2-selection__rendered" id="select2-qrjm-container"
                                                    role="textbox" aria-readonly="true"
                                                    title="Guest">Guest</span><span class="select2-selection__arrow"
                                                    role="presentation"><b
                                                        role="presentation"></b></span></span></span><span
                            ...
                            <div class="d-flex flex-stack py-4">
                                ...
                                <div class="ms-2 w-100px">
                                    <select class="form-select form-select-solid form-select-sm select2-hidden-accessible"
                                        data-control="select2" data-hide-search="true"
                                        data-select2-id="select2-data-58-y5tl" tabindex="-1" aria-hidden="true">
                                        <option value="1">Guest</option>
                                        <option value="2">Owner</option>
                                        <option value="3" selected="selected"
                                        ...
                                        style="width: 100%;"><span class="selection"><span
                                                ...
                                                aria-controls="select2-ri33-container"><span
                                                    class="select2-selection__rendered" id="select2-ri33-container"
                                                    role="textbox" aria-readonly="true" title="Can Edit">Can
                                                    Edit</span><span class="select2-selection__arrow"
                                                    role="presentation"><b
                                                        role="presentation"></b></span></span></span><span
                                    ...
                                    <div class="w-100">
                                        ...
                                        <div class="fv-row">
                                            ...
                                            <label class="d-flex align-items-center fs-5 fw-bold mb-4">
                                                ...
                                                <i class="fas fa-exclamation-circle ms-2 fs-7" data-bs-toggle="tooltip"
                                                    title="" data-bs-original-title="Select your app category"
                                    ...
                                    <div class="w-100">
                                        ...
                                        <div class="fv-row fv-plugins-icon-container">
                                            ...
                                            <label class="d-flex align-items-center fs-5 fw-bold mb-4">
                                                ...
                                                <i class="fas fa-exclamation-circle ms-2 fs-7" data-bs-toggle="tooltip"
                                                    title="" data-bs-original-title="Specify your apps framework"
                                                ...
                                                <div class="row fv-row fv-plugins-icon-container">
                                                    ...
                                                    <div class="col-6">
                                                        <select name="card_expiry_month"
                                                            ...
                                                            data-select2-id="select2-data-61-z23r" tabindex="-1"
                                                            aria-hidden="true">
                                                            ...
                                                            dir="ltr" data-select2-id="select2-data-62-d1ze"
                                                            style="width: 100%;"><span class="selection"><span
                                                    ...
                                                    <div class="col-6">
                                                        <select name="card_expiry_year"
                                                            ...
                                                            data-select2-id="select2-data-64-n2is" tabindex="-1"
                                                            aria-hidden="true">
                                                            ...
                                                            class="select2 select2-container select2-container--bootstrap5"
                                                            dir="ltr" data-select2-id="select2-data-65-t9sv"
                                                            style="width: 100%;"><span class="selection"><span
                                                                    class="select2-selection select2-selection--single form-select form-select-solid"
                                                                    role="combobox" aria-haspopup="true"
                                                                    aria-expanded="false" tabindex="0"
                                            ...
                                            <span class="svg-icon svg-icon-3 me-1">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                    ...
                                                    <rect opacity="0.5" x="6" y="11"
                                                        width="13" height="2" rx="1" fill="black">
                                                    </rect>
                                                    <path
        ...
        <div class="flatpickr-innerContainer">
            <div class="flatpickr-rContainer">
                ...
                <div class="flatpickr-days" tabindex="-1">
                    <div class="dayContainer"><span class="flatpickr-day prevMonthDay" aria-label="September 25, 2022"
                            tabindex="-1">25</span><span class="flatpickr-day prevMonthDay"
                            aria-label="September 26, 2022" tabindex="-1">26</span><span
                            class="flatpickr-day prevMonthDay" aria-label="September 27, 2022"
                            tabindex="-1">27</span><span class="flatpickr-day prevMonthDay"
                            aria-label="September 28, 2022" tabindex="-1">28</span><span
                            class="flatpickr-day prevMonthDay" aria-label="September 29, 2022"
                            tabindex="-1">29</span><span class="flatpickr-day prevMonthDay"
                            aria-label="September 30, 2022" tabindex="-1">30</span><span class="flatpickr-day "
                            aria-label="October 1, 2022" tabindex="-1">1</span><span class="flatpickr-day "
                            aria-label="October 2, 2022" tabindex="-1">2</span><span class="flatpickr-day "
                            aria-label="October 3, 2022" tabindex="-1">3</span><span class="flatpickr-day "
                            aria-label="October 4, 2022" tabindex="-1">4</span><span class="flatpickr-day "
                            aria-label="October 5, 2022" tabindex="-1">5</span><span class="flatpickr-day "
                            aria-label="October 6, 2022" tabindex="-1">6</span><span class="flatpickr-day "
                            aria-label="October 7, 2022" tabindex="-1">7</span><span class="flatpickr-day "
                            aria-label="October 8, 2022" tabindex="-1">8</span><span class="flatpickr-day "
                            aria-label="October 9, 2022" tabindex="-1">9</span><span class="flatpickr-day "
                            aria-label="October 10, 2022" tabindex="-1">10</span><span class="flatpickr-day "
                            aria-label="October 11, 2022" tabindex="-1">11</span><span class="flatpickr-day "
                            aria-label="October 12, 2022" tabindex="-1">12</span><span class="flatpickr-day "
                            aria-label="October 13, 2022" tabindex="-1">13</span><span class="flatpickr-day "
                            aria-label="October 14, 2022" tabindex="-1">14</span><span class="flatpickr-day "
                            aria-label="October 15, 2022" tabindex="-1">15</span><span class="flatpickr-day selected"
                            ...
                            aria-label="October 22, 2022" tabindex="-1">22</span><span class="flatpickr-day today"
                            aria-label="October 23, 2022" aria-current="date" tabindex="-1">23</span><span
                            class="flatpickr-day " aria-label="October 24, 2022" tabindex="-1">24</span><span
                            class="flatpickr-day " aria-label="October 25, 2022" tabindex="-1">25</span><span
                            class="flatpickr-day " aria-label="October 26, 2022" tabindex="-1">26</span><span
                            class="flatpickr-day " aria-label="October 27, 2022" tabindex="-1">27</span><span
                            class="flatpickr-day " aria-label="October 28, 2022" tabindex="-1">28</span><span
                            class="flatpickr-day " aria-label="October 29, 2022" tabindex="-1">29</span><span
                            class="flatpickr-day " aria-label="October 30, 2022" tabindex="-1">30</span><span
                            class="flatpickr-day " aria-label="October 31, 2022" tabindex="-1">31</span><span
                            class="flatpickr-day nextMonthDay" aria-label="November 1, 2022"
                            tabindex="-1">1</span><span class="flatpickr-day nextMonthDay"
                            aria-label="November 2, 2022" tabindex="-1">2</span><span
                            class="flatpickr-day nextMonthDay" aria-label="November 3, 2022"
                            tabindex="-1">3</span><span class="flatpickr-day nextMonthDay"
                            aria-label="November 4, 2022" tabindex="-1">4</span><span
                            class="flatpickr-day nextMonthDay" aria-label="November 5, 2022" tabindex="-1">5</span>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="flatpickr-rContainer">
                ...
                <div class="flatpickr-days" tabindex="-1">
                    <div class="dayContainer"><span class="flatpickr-day prevMonthDay" aria-label="September 25, 2022"
                            ...
                            aria-label="October 13, 2022" tabindex="-1">13</span><span class="flatpickr-day "
                            aria-label="October 14, 2022" tabindex="-1">14</span><span class="flatpickr-day "
                            aria-label="October 15, 2022" tabindex="-1">15</span><span class="flatpickr-day "
                            aria-label="October 16, 2022" tabindex="-1">16</span><span class="flatpickr-day selected"
                            aria-label="October 17, 2022" tabindex="-1">17</span><span class="flatpickr-day "
                            aria-label="October 18, 2022" tabindex="-1">18</span><span class="flatpickr-day "
                            aria-label="October 19, 2022" tabindex="-1">19</span><span class="flatpickr-day "
                            aria-label="October 20, 2022" tabindex="-1">20</span><span class="flatpickr-day "
    ...
    <div class="popover fade show bs-popover-top" role="tooltip" id="popover836208" data-popper-placement="top"
